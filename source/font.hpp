...
struct character_properties {
     ...
     */
    character_properties(const uint8_t& encoding, const std::pair<uint16_t, uint16_t>& s_width, const std::pair<uint8_t, uint8_t>& d_width, const bounding_box& b_box )
    : encoding(encoding)
